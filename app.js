...
['10:10','✈️','抵達關西機場','入境、領行李後前往京都。','Kansai International Airport'],['13:30','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','寄放行李並稍作休息。',hotels.kyoto.map],['15:00','🍢','錦市場','先逛較早收店的市場。','Nishiki Market Kyoto'],['16:00','🌆','河原町','市中心街區散步。','Kyoto Kawaramachi'],['16:30','🛍️','寺町・新京極','依孩子體力彈性逛街。','Shinkyogoku Shopping Street'],['17:15','⭐','3COINS +plus 河原町 OPA 店','本次指定的 3COINS。','3COINS +plus 河原町OPA店'],['18:10','🏬','京都高島屋 S.C.／Nintendo KYOTO','百貨與角色周邊。','Kyoto Takashimaya S.C.'],['19:30','🍜','麵匠たか松','第一天晚餐。','麺匠 たか松 四条店'],['21:00','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','返回飯店住宿。',hotels.kyoto.map]],foodArea:'河原町'},
...
['08:00','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','從飯店出發。',hotels.kyoto.map],['08:30','🚆','京都 → 宇治','搭 JR 前往宇治。','Uji Station Kyoto'],['09:15','🍵','宇治表參道','抹茶甜點與伴手禮。','Byodoin Omotesando Uji'],['10:15','🏯','平等院','參觀鳳凰堂與庭園。','Byodoin Temple'],['11:45','🌉','宇治川','河岸散步。','Uji River'],['13:00','🚆','宇治 → 奈良','搭 JR 前往奈良。','Nara Station'],['14:15','🦌','奈良公園','親子餵鹿與散步。','Nara Park'],['15:45','🏯','東大寺','參觀大佛殿。','Todaiji Temple'],['19:30','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','返回京都住宿。',hotels.kyoto.map]],foodArea:'宇治奈良'},
...
['07:30','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','從飯店出發。',hotels.kyoto.map],['08:00','🏯','清水寺','清晨人潮相對較少。','Kiyomizu-dera'],['09:30','📷','二年坂・三年坂','沿石板坡道慢慢散步。','Sannenzaka Kyoto'],['15:30','🏬','JR 京都伊勢丹','購買伴手禮與熟食。','JR Kyoto Isetan'],['19:00','🏨','Daiwa Roynet Hotel Kyoto Shijo Karasuma','返回飯店住宿。',hotels.kyoto.map]],foodArea:'京都車站'},
...
['07:15','🧳','京都飯店退房','由 Daiwa Roynet Hotel 退房後前往 USJ。',hotels.kyoto.map],['09:00','🌍','USJ 入園自由行','入園後依現場等候時間彈性遊玩。','Universal Studios Japan'],['11:00','🪄','哈利波特／親子園區','哈利波特魔法世界與親子設施自由安排。','The Wizarding World of Harry Potter Japan'],['15:30','🦈','JAWS 快速通關','依快速通關安排體驗。','JAWS Universal Studios Japan'],['16:35','🍄','超級任天堂世界','依指定時間提早抵達入口。','Super Nintendo World Japan'],['17:10','🏎️','瑪利歐賽車：庫巴的挑戰書','使用快速通關入場。','Mario Kart Koopa Challenge'],['17:40','🦍','咚奇剛國度：礦車瘋狂™','使用快速通關體驗。','Donkey Kong Country USJ'],['19:30','🚆','前往機場飯店','離開 USJ 後前往臨空城。',hotels.airport.map],['21:00','🏨','Odysis Suites Osaka Airport Hotel','辦理入住並整理隔日返台行李。',hotels.airport.map]],foodArea:'USJ'},
...
['07:00','🏨','Odysis Suites Osaka Airport Hotel','早餐、最後整理並退房。',hotels.airport.map],['08:15','✈️','關西國際機場（KIX）','完成報到、托運與安檢。','Kansai International Airport'],['11:10','🇹🇼','BR177 返回台灣','旅程完成，平安回家。','Kansai International Airport']],foodArea:'關西機場'}];
...
{area:'河原町',name:'麵匠 Takamatsu 四條店',type:'拉麵／沾麵',rating:'4.3',reviews:'1,000+',budget:'¥1,000–2,000',kid:'可',desc:'四條烏丸附近的人氣沾麵，適合第一天或回飯店前用餐。',map:'麺匠 たか松 四条店'},
{area:'河原町',name:'京極かねよ',type:'鰻魚／京都料理',rating:'4.1',reviews:'1,500+',budget:'¥2,500–4,000',kid:'可',desc:'京都老字號鰻魚飯，想吃特色正餐時可選。',map:'Kyogoku Kane-yo Kyoto'},
{area:'河原町',name:'京都高島屋餐廳樓層',type:'多國料理',rating:'4.0+',reviews:'百貨內多店',budget:'¥1,500–3,000',kid:'親子友善',desc:'有冷氣、洗手間與多種選擇，孩子累時最穩。',map:'Kyoto Takashimaya Restaurant'},
{area:'宇治奈良',name:'中村藤吉 宇治本店',type:'抹茶／甜點',rating:'4.4',reviews:'4,000+',budget:'¥1,500–2,500',kid:'可',desc:'宇治代表性抹茶餐點，熱門時先取號再去附近散步。',map:'Nakamura Tokichi Honten Uji'},
{area:'宇治奈良',name:'伊藤久右衛門 JR宇治站前店',type:'抹茶／蕎麥麵',rating:'4.2',reviews:'2,000+',budget:'¥1,200–2,500',kid:'親子友善',desc:'離 JR 宇治站近，行程彈性高。',map:'Itoh Kyuemon JR Uji Station'},
{area:'宇治奈良',name:'志津香 公園店',type:'釜飯',rating:'4.1',reviews:'2,000+',budget:'¥1,500–2,500',kid:'可',desc:'奈良經典釜飯，排隊過長時不必勉強。',map:'Kamameshi Shizuka Nara Park'},
{area:'京都車站',name:'京都拉麵小路',type:'拉麵',rating:'4.2',reviews:'5,000+',budget:'¥1,000–1,800',kid:'可',desc:'伊勢丹樓上多家拉麵店，可依現場隊伍決定。',map:'Kyoto Ramen Koji'},
{area:'京都車站',name:'JR 京都伊勢丹餐廳街',type:'多國料理',rating:'4.0+',reviews:'百貨內多店',budget:'¥1,500–3,500',kid:'親子友善',desc:'購物後直接用餐最省力。',map:'JR Kyoto Isetan Restaurant'},
{area:'京都車站',name:'奥丹清水',type:'湯豆腐／京都料理',rating:'4.1',reviews:'1,000+',budget:'¥3,000–5,000',kid:'可',desc:'想安排一餐傳統京都風味時可選。',map:'Okutan Kiyomizu Kyoto'},
{area:'USJ',name:'Studio Stars Restaurant',type:'西式／親子',rating:'4.0',reviews:'1,000+',budget:'¥1,500–2,500',kid:'親子友善',desc:'座位與餐點選擇相對穩定，適合提早午餐。',map:'Studio Stars Restaurant USJ'},
{area:'USJ',name:'Snoopy Backlot Cafe',type:'速食／親子',rating:'4.1',reviews:'500+',budget:'¥1,200–2,000',kid:'很適合',desc:'小朋友接受度高，搭配親子園區動線。',map:'Snoopy Backlot Cafe USJ'},
{area:'關西機場',name:'關西機場餐廳區',type:'多國料理',rating:'4.0+',reviews:'依店家',budget:'¥1,000–2,500',kid:'親子友善',desc:'完成報到與安檢後再依時間決定。',map:'Kansai Airport restaurants'}
];
